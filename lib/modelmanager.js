...
class ModelManager {
     ...
     */
    addModelFile(modelFile, fileName, disableValidation,isSystemModelFile) {
     ...
     */
    addModelFiles(modelFiles, fileNames, disableValidation,isSystemModelFile) {
