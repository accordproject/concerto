...
function peg$parse(input, options) {
  ...
  var peg$e135 = peg$classExpectation([["0", "9"], ["A", "Z"], ["a", "z"], "-"], false, false);
  ...
  var peg$f88 = function(version) {
       return version.value;
     };
  var peg$f89 = function(version, ns, imports, body) {
      const result = {
