...
function peg$parse(input, options) {
  ...
  var peg$f87 = function(ns, types, u) {
    	const result = {
  ...
  var peg$f90 = function(version, decorators, ns, imports, body) {
      const result = {
