...
describe('Model Tests', function(){
    ...
    describe('#validation', function() {
        it('check property validation', function() {
            ...
            const dateTime = Moment.parseZone('2016-10-11T02:30:26Z');
